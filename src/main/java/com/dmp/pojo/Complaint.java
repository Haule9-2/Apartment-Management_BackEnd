...
@NamedQueries({
    ...
    @NamedQuery(name = "Complaint.findByImage", query = "SELECT c FROM Complaint c WHERE c.image = :image")})
public class Complaint implements Serializable {
    ...
    public Complaint(Integer id, String title, String content, Date createdDate) {
        this.id = id;
        this.title = title;
    ...
    public String toString() {
        return "com.dmp.pojo.Complaint[ id=" + id + " ]";
    }
